...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CreateShipSystemScan201ResponseData : IEquatable<CreateShipSystemScan201ResponseData>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateShipSystemScan201ResponseData(Cooldown cooldown = default(Cooldown), List<ScannedSystem> systems = default(List<ScannedSystem>))
        {
        ...
        {
            return this.Equals(input as CreateShipSystemScan201ResponseData);
        }

        /// <summary>
        /// Returns true if CreateShipSystemScan201ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateShipSystemScan201ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateShipSystemScan201ResponseData input)
        {
            if (input == null)
            {
                return false;
