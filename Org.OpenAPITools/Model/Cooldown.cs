...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Cooldown : IEquatable<Cooldown>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ShipSymbol, length must be greater than 1.", new [] { "ShipSymbol" });
            }

            // TotalSeconds (int) minimum
            if (this.TotalSeconds < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TotalSeconds, must be a value greater than or equal to 0.", new [] { "TotalSeconds" });
            }

            // RemainingSeconds (int) minimum
            if (this.RemainingSeconds < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for RemainingSeconds, must be a value greater than or equal to 0.", new [] { "RemainingSeconds" });
            }
