...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ShipCargoItem : IEquatable<ShipCargoItem>, IValidatableObject
    {
        ...
        public ShipCargoItem(string symbol = default(string), string name = default(string), string description = default(string), int units = default(int))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ShipCargoItem and cannot be null");
            }
            this.Name = name;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for ShipCargoItem and cannot be null");
            }
