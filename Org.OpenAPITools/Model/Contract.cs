...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Contract : IEquatable<Contract>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FactionSymbol, length must be greater than 1.", new [] { "FactionSymbol" });
            }
