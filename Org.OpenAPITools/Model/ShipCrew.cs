...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ShipCrew : IEquatable<ShipCrew>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Morale, must be a value less than or equal to 100.", new [] { "Morale" });
            }

            // Morale (int) minimum
            if (this.Morale < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Morale, must be a value greater than or equal to 0.", new [] { "Morale" });
            }

            // Wages (int) minimum
            if (this.Wages < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Wages, must be a value greater than or equal to 0.", new [] { "Wages" });
            }
