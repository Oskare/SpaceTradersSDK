...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class StarSystem : IEquatable<StarSystem>, IValidatableObject
    {
        ...
        public StarSystem(string symbol = default(string), string sectorSymbol = default(string), SystemType type = default(SystemType), int x = default(int), int y = default(int), List<SystemWaypoint> waypoints = default(List<SystemWaypoint>), List<SystemFaction> factions = default(List<SystemFaction>))
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SectorSymbol, length must be greater than 1.", new [] { "SectorSymbol" });
            }
