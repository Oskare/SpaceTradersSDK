...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MarketTradeGood : IEquatable<MarketTradeGood>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TradeVolume, must be a value greater than or equal to 1.", new [] { "TradeVolume" });
            }

            // PurchasePrice (int) minimum
            if (this.PurchasePrice < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for PurchasePrice, must be a value greater than or equal to 0.", new [] { "PurchasePrice" });
            }

            // SellPrice (int) minimum
            if (this.SellPrice < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for SellPrice, must be a value greater than or equal to 0.", new [] { "SellPrice" });
            }
