...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "navigate_ship_200_response_data")]
    public partial class NavigateShip200ResponseData : IEquatable<NavigateShip200ResponseData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NavigateShip200ResponseData" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected NavigateShip200ResponseData() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NavigateShip200ResponseData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as NavigateShip200ResponseData);
        }

        /// <summary>
        /// Returns true if NavigateShip200ResponseData instances are equal
        /// </summary>
        /// <param name="input">Instance of NavigateShip200ResponseData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NavigateShip200ResponseData input)
        {
            if (input == null)
            {
                return false;
