...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ContractDeliverGood : IEquatable<ContractDeliverGood>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TradeSymbol, length must be greater than 1.", new [] { "TradeSymbol" });
            }

            // DestinationSymbol (string) minLength
            if (this.DestinationSymbol != null && this.DestinationSymbol.Length < 1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for DestinationSymbol, length must be greater than 1.", new [] { "DestinationSymbol" });
            }
