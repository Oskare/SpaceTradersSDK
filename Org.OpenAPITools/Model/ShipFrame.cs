...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class ShipFrame : IEquatable<ShipFrame>, IValidatableObject
    {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Condition, must be a value less than or equal to 100.", new [] { "Condition" });
            }

            // Condition (int) minimum
            if (this.Condition < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Condition, must be a value greater than or equal to 0.", new [] { "Condition" });
            }

            // ModuleSlots (int) minimum
            if (this.ModuleSlots < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ModuleSlots, must be a value greater than or equal to 0.", new [] { "ModuleSlots" });
            }

            // MountingPoints (int) minimum
            if (this.MountingPoints < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MountingPoints, must be a value greater than or equal to 0.", new [] { "MountingPoints" });
            }

            // FuelCapacity (int) minimum
            if (this.FuelCapacity < (int)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for FuelCapacity, must be a value greater than or equal to 0.", new [] { "FuelCapacity" });
            }
